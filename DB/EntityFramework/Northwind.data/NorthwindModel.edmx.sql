...
-- --------------------------------------------------
-- Date Created: 07/17/2013 17:15:41
-- Generated from EDMX file: D:\others\telerik HW\DB\EntityFramework\Northwind.data\NorthwindModel.edmx
-- --------------------------------------------------
...
-- Creating table 'Order_Detail1'
CREATE TABLE [dbo].[Order_Detail1] (
    [OrderID] int  NOT NULL,
    [ProductID] int  NOT NULL,
    [UnitPrice] decimal(19,4)  NOT NULL,
    [Quantity] smallint  NOT NULL,
...
-- Creating table 'Alphabetical_list_of_product1'
CREATE TABLE [dbo].[Alphabetical_list_of_product1] (
    [ProductID] int  NOT NULL,
    [ProductName] nvarchar(40)  NOT NULL,
    [SupplierID] int  NULL,
    [CategoryID] int  NULL,
...
-- Creating table 'Category_Sales_for_19971'
CREATE TABLE [dbo].[Category_Sales_for_19971] (
    [CategoryName] nvarchar(15)  NOT NULL,
    [CategorySales] decimal(19,4)  NULL
);
GO

-- Creating table 'Current_Product_List1'
CREATE TABLE [dbo].[Current_Product_List1] (
    [ProductID] int IDENTITY(1,1) NOT NULL,
    [ProductName] nvarchar(40)  NOT NULL
);
GO

-- Creating table 'Customer_and_Suppliers_by_City1'
CREATE TABLE [dbo].[Customer_and_Suppliers_by_City1] (
    [City] nvarchar(15)  NULL,
    [CompanyName] nvarchar(40)  NOT NULL,
    [ContactName] nvarchar(30)  NULL,
    [Relationship] varchar(9)  NOT NULL
...
-- Creating table 'Order_Details_Extended1'
CREATE TABLE [dbo].[Order_Details_Extended1] (
    [OrderID] int  NOT NULL,
    [ProductID] int  NOT NULL,
    [ProductName] nvarchar(40)  NOT NULL,
    [UnitPrice] decimal(19,4)  NOT NULL,
...
-- Creating table 'Order_Subtotal1'
CREATE TABLE [dbo].[Order_Subtotal1] (
    [OrderID] int  NOT NULL,
    [Subtotal] decimal(19,4)  NULL
);
GO

-- Creating table 'Orders_Qry1'
CREATE TABLE [dbo].[Orders_Qry1] (
    [OrderID] int  NOT NULL,
    [CustomerID] nchar(5)  NULL,
    [EmployeeID] int  NULL,
    [OrderDate] datetime  NULL,
...
-- Creating table 'Product_Sales_for_19971'
CREATE TABLE [dbo].[Product_Sales_for_19971] (
    [CategoryName] nvarchar(15)  NOT NULL,
    [ProductName] nvarchar(40)  NOT NULL,
    [ProductSales] decimal(19,4)  NULL
);
...
-- Creating table 'Products_Above_Average_Price1'
CREATE TABLE [dbo].[Products_Above_Average_Price1] (
    [ProductName] nvarchar(40)  NOT NULL,
    [UnitPrice] decimal(19,4)  NULL
);
GO

-- Creating table 'Products_by_Category1'
CREATE TABLE [dbo].[Products_by_Category1] (
    [CategoryName] nvarchar(15)  NOT NULL,
    [ProductName] nvarchar(40)  NOT NULL,
    [QuantityPerUnit] nvarchar(20)  NULL,
    [UnitsInStock] smallint  NULL,
...
-- Creating table 'Sales_by_Category1'
CREATE TABLE [dbo].[Sales_by_Category1] (
    [CategoryID] int  NOT NULL,
    [CategoryName] nvarchar(15)  NOT NULL,
    [ProductName] nvarchar(40)  NOT NULL,
    [ProductSales] decimal(19,4)  NULL
...
-- Creating table 'Sales_Totals_by_Amount1'
CREATE TABLE [dbo].[Sales_Totals_by_Amount1] (
    [SaleAmount] decimal(19,4)  NULL,
    [OrderID] int  NOT NULL,
    [CompanyName] nvarchar(40)  NOT NULL,
    [ShippedDate] datetime  NULL
...
-- Creating table 'Summary_of_Sales_by_Quarter1'
CREATE TABLE [dbo].[Summary_of_Sales_by_Quarter1] (
    [ShippedDate] datetime  NULL,
    [OrderID] int  NOT NULL,
    [Subtotal] decimal(19,4)  NULL
);
...
-- Creating table 'Summary_of_Sales_by_Year1'
CREATE TABLE [dbo].[Summary_of_Sales_by_Year1] (
    [ShippedDate] datetime  NULL,
    [OrderID] int  NOT NULL,
    [Subtotal] decimal(19,4)  NULL
);
...
-- Creating table 'CustomerCustomerDemo1'
CREATE TABLE [dbo].[CustomerCustomerDemo1] (
    [CustomerDemographics1_CustomerTypeID] nchar(10)  NOT NULL,
    [Customers1_CustomerID] nchar(5)  NOT NULL
);
GO

-- Creating table 'EmployeeTerritories1'
CREATE TABLE [dbo].[EmployeeTerritories1] (
    [Employees1_EmployeeID] int  NOT NULL,
    [Territories1_TerritoryID] nvarchar(20)  NOT NULL
);
GO
...
-- Creating primary key on [OrderID], [ProductID] in table 'Order_Detail1'
ALTER TABLE [dbo].[Order_Detail1]
ADD CONSTRAINT [PK_Order_Detail1]
    PRIMARY KEY CLUSTERED ([OrderID], [ProductID] ASC);
GO

-- Creating primary key on [RegionID] in table 'Region1'
ALTER TABLE [dbo].[Region1]
ADD CONSTRAINT [PK_Region1]
    PRIMARY KEY CLUSTERED ([RegionID] ASC);
GO

-- Creating primary key on [ProductID], [ProductName], [Discontinued], [CategoryName] in table 'Alphabetical_list_of_product1'
ALTER TABLE [dbo].[Alphabetical_list_of_product1]
ADD CONSTRAINT [PK_Alphabetical_list_of_product1]
    PRIMARY KEY CLUSTERED ([ProductID], [ProductName], [Discontinued], [CategoryName] ASC);
GO

-- Creating primary key on [CategoryName] in table 'Category_Sales_for_19971'
ALTER TABLE [dbo].[Category_Sales_for_19971]
ADD CONSTRAINT [PK_Category_Sales_for_19971]
    PRIMARY KEY CLUSTERED ([CategoryName] ASC);
GO

-- Creating primary key on [ProductID], [ProductName] in table 'Current_Product_List1'
ALTER TABLE [dbo].[Current_Product_List1]
ADD CONSTRAINT [PK_Current_Product_List1]
    PRIMARY KEY CLUSTERED ([ProductID], [ProductName] ASC);
GO

-- Creating primary key on [CompanyName], [Relationship] in table 'Customer_and_Suppliers_by_City1'
ALTER TABLE [dbo].[Customer_and_Suppliers_by_City1]
ADD CONSTRAINT [PK_Customer_and_Suppliers_by_City1]
    PRIMARY KEY CLUSTERED ([CompanyName], [Relationship] ASC);
GO

-- Creating primary key on [CustomerName], [Salesperson], [OrderID], [ShipperName], [ProductID], [ProductName], [UnitPrice], [Quantity], [Discount] in table 'Invoice1'
ALTER TABLE [dbo].[Invoice1]
ADD CONSTRAINT [PK_Invoice1]
    PRIMARY KEY CLUSTERED ([CustomerName], [Salesperson], [OrderID], [ShipperName], [ProductID], [ProductName], [UnitPrice], [Quantity], [Discount] ASC);
GO

-- Creating primary key on [OrderID], [ProductID], [ProductName], [UnitPrice], [Quantity], [Discount] in table 'Order_Details_Extended1'
ALTER TABLE [dbo].[Order_Details_Extended1]
ADD CONSTRAINT [PK_Order_Details_Extended1]
    PRIMARY KEY CLUSTERED ([OrderID], [ProductID], [ProductName], [UnitPrice], [Quantity], [Discount] ASC);
GO

-- Creating primary key on [OrderID] in table 'Order_Subtotal1'
ALTER TABLE [dbo].[Order_Subtotal1]
ADD CONSTRAINT [PK_Order_Subtotal1]
    PRIMARY KEY CLUSTERED ([OrderID] ASC);
GO

-- Creating primary key on [OrderID], [CompanyName] in table 'Orders_Qry1'
ALTER TABLE [dbo].[Orders_Qry1]
ADD CONSTRAINT [PK_Orders_Qry1]
    PRIMARY KEY CLUSTERED ([OrderID], [CompanyName] ASC);
GO

-- Creating primary key on [CategoryName], [ProductName] in table 'Product_Sales_for_19971'
ALTER TABLE [dbo].[Product_Sales_for_19971]
ADD CONSTRAINT [PK_Product_Sales_for_19971]
    PRIMARY KEY CLUSTERED ([CategoryName], [ProductName] ASC);
GO

-- Creating primary key on [ProductName] in table 'Products_Above_Average_Price1'
ALTER TABLE [dbo].[Products_Above_Average_Price1]
ADD CONSTRAINT [PK_Products_Above_Average_Price1]
    PRIMARY KEY CLUSTERED ([ProductName] ASC);
GO

-- Creating primary key on [CategoryName], [ProductName], [Discontinued] in table 'Products_by_Category1'
ALTER TABLE [dbo].[Products_by_Category1]
ADD CONSTRAINT [PK_Products_by_Category1]
    PRIMARY KEY CLUSTERED ([CategoryName], [ProductName], [Discontinued] ASC);
GO

-- Creating primary key on [CategoryID], [CategoryName], [ProductName] in table 'Sales_by_Category1'
ALTER TABLE [dbo].[Sales_by_Category1]
ADD CONSTRAINT [PK_Sales_by_Category1]
    PRIMARY KEY CLUSTERED ([CategoryID], [CategoryName], [ProductName] ASC);
GO

-- Creating primary key on [OrderID], [CompanyName] in table 'Sales_Totals_by_Amount1'
ALTER TABLE [dbo].[Sales_Totals_by_Amount1]
ADD CONSTRAINT [PK_Sales_Totals_by_Amount1]
    PRIMARY KEY CLUSTERED ([OrderID], [CompanyName] ASC);
GO

-- Creating primary key on [OrderID] in table 'Summary_of_Sales_by_Quarter1'
ALTER TABLE [dbo].[Summary_of_Sales_by_Quarter1]
ADD CONSTRAINT [PK_Summary_of_Sales_by_Quarter1]
    PRIMARY KEY CLUSTERED ([OrderID] ASC);
GO

-- Creating primary key on [OrderID] in table 'Summary_of_Sales_by_Year1'
ALTER TABLE [dbo].[Summary_of_Sales_by_Year1]
ADD CONSTRAINT [PK_Summary_of_Sales_by_Year1]
    PRIMARY KEY CLUSTERED ([OrderID] ASC);
GO
...
-- Creating primary key on [CustomerDemographics1_CustomerTypeID], [Customers1_CustomerID] in table 'CustomerCustomerDemo1'
ALTER TABLE [dbo].[CustomerCustomerDemo1]
ADD CONSTRAINT [PK_CustomerCustomerDemo1]
    PRIMARY KEY NONCLUSTERED ([CustomerDemographics1_CustomerTypeID], [Customers1_CustomerID] ASC);
GO

-- Creating primary key on [Employees1_EmployeeID], [Territories1_TerritoryID] in table 'EmployeeTerritories1'
ALTER TABLE [dbo].[EmployeeTerritories1]
ADD CONSTRAINT [PK_EmployeeTerritories1]
    PRIMARY KEY NONCLUSTERED ([Employees1_EmployeeID], [Territories1_TerritoryID] ASC);
GO
...
-- Creating foreign key on [CustomerDemographics1_CustomerTypeID] in table 'CustomerCustomerDemo1'
ALTER TABLE [dbo].[CustomerCustomerDemo1]
ADD CONSTRAINT [FK_CustomerCustomerDemo1_CustomerDemographic]
    FOREIGN KEY ([CustomerDemographics1_CustomerTypeID])
    REFERENCES [dbo].[CustomerDemographics]
        ([CustomerTypeID])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO

-- Creating foreign key on [Customers1_CustomerID] in table 'CustomerCustomerDemo1'
ALTER TABLE [dbo].[CustomerCustomerDemo1]
ADD CONSTRAINT [FK_CustomerCustomerDemo1_Customer]
    FOREIGN KEY ([Customers1_CustomerID])
    REFERENCES [dbo].[Customers]
        ([CustomerID])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK_CustomerCustomerDemo1_Customer'
CREATE INDEX [IX_FK_CustomerCustomerDemo1_Customer]
ON [dbo].[CustomerCustomerDemo1]
    ([Customers1_CustomerID]);
GO

-- Creating foreign key on [Employees1_EmployeeID] in table 'EmployeeTerritories1'
ALTER TABLE [dbo].[EmployeeTerritories1]
ADD CONSTRAINT [FK_EmployeeTerritories1_Employee]
    FOREIGN KEY ([Employees1_EmployeeID])
    REFERENCES [dbo].[Employees]
        ([EmployeeID])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO

-- Creating foreign key on [Territories1_TerritoryID] in table 'EmployeeTerritories1'
ALTER TABLE [dbo].[EmployeeTerritories1]
ADD CONSTRAINT [FK_EmployeeTerritories1_Territory]
    FOREIGN KEY ([Territories1_TerritoryID])
    REFERENCES [dbo].[Territories]
        ([TerritoryID])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK_EmployeeTerritories1_Territory'
CREATE INDEX [IX_FK_EmployeeTerritories1_Territory]
ON [dbo].[EmployeeTerritories1]
    ([Territories1_TerritoryID]);
GO

-- Creating foreign key on [OrderID] in table 'Order_Detail1'
ALTER TABLE [dbo].[Order_Detail1]
...
-- Creating foreign key on [ProductID] in table 'Order_Detail1'
ALTER TABLE [dbo].[Order_Detail1]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_Order_Details_Products1'
CREATE INDEX [IX_FK_Order_Details_Products1]
ON [dbo].[Order_Detail1]
    ([ProductID]);
GO

-- Creating foreign key on [RegionID] in table 'Territories'
ALTER TABLE [dbo].[Territories]
ADD CONSTRAINT [FK_Territories_Region1]
    FOREIGN KEY ([RegionID])
    REFERENCES [dbo].[Region1]
        ([RegionID])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK_Territories_Region1'
CREATE INDEX [IX_FK_Territories_Region1]
ON [dbo].[Territories]
    ([RegionID]);
GO
