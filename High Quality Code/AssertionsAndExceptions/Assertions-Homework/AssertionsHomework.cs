...
class AssertionsHomework
{
        ...
        where T : IComparable<T>
    {
        ...
        Debug.Assert(endIndex <= arr.Length, "End index is gratter than array length.");
        ...
        Debug.Assert(minElementIndex >= 0 || minElementIndex <= arr.Length, "Min Element Index is not in array boundaries.");
