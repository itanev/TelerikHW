<?php get_header(); ?>
    <div id="site_content">
      ...
      <div class="content">
        <img style="float: left; vertical-align: middle; margin: 0 10px 0 0;" src="<?php echo get_template_directory_uri(); ?>/images/home.png" alt="home" /><h1 style="margin: 15px 0 0 0;">Welcome to the CSS3_six template</h1>
