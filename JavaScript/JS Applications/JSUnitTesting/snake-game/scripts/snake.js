...
var snakeGame = (function() {
  ...
  var SnakeGame = Class.create({
    ...
    checkForWallCollisions: function() {
      var i;
    ...
    checkForFoodCollision: function() {
      for (var i = 0; i < this.gameObjects.length; i += 1) {
    ...
    checkForSelfCollision: function() {
      var i;
      var snakehead = this.snake.pieces[0];
      for(i = 1; i < this.snake.size; i+=1) {
        var piece = this.snake.pieces[i];
        if(snakehead.position.x == piece.position.x &&
              snakehead.position.y == piece.position.y) {
          this.snake.die();
        }
      }
    },
